...
class SWAPIFilmSerializerTest(TestCase):
    def test_film_serializer_valid_data(self):
        ...
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/films/1/')
    ...
    def test_film_serializer_source_mapping(self):
        ...
        data = {
            'title': 'Test Film',
            'url': 'https://swapi.info/api/films/99/'
        }
        serializer = serializers.SWAPIFilmSerializer(data=data)
        self.assertTrue(serializer.is_valid())
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/films/99/')
...
class SWAPICharacterSerializerTest(TestCase):
    def test_character_serializer_valid_data(self):
        ...
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/people/1/')
    ...
    def test_character_serializer_unknown_height(self):
        ...
        self.assertEqual(serializer.validated_data['films'], ['https://swapi.info/api/films/1/'])
    ...
    def test_character_serializer_source_mapping(self):
        ...
        serializer = serializers.SWAPICharacterSerializer(data=data)
        self.assertTrue(serializer.is_valid())
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/people/99/')
        self.assertEqual(serializer.validated_data['films'], ['https://swapi.info/api/films/1/'])
...
class SWAPIStarshipSerializerTest(TestCase):
    def test_starship_serializer_valid_data(self):
        ...
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/starships/10/')
    ...
    def test_starship_serializer_source_mapping(self):
        ...
        self.assertTrue(serializer.is_valid())
        self.assertEqual(serializer.validated_data['swapi_url'], 'https://swapi.info/api/starships/10/')
        self.assertEqual(serializer.validated_data['characters'], ['https://swapi.info/api/people/13/'])
