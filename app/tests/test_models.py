...
class FilmModelTest(TestCase):
    def test_create_film(self):
        ...
        self.assertEqual(str(film), '(1) Title: A New Hope, Director: George Lucas, Release date: 1977-05-25')
...
class CharacterModelTest(TestCase):
    def test_create_character(self):
        ...
        self.assertEqual(str(character), '(1) Name: Luke Skywalker, Gender: male, Height: 172.5')
...
class StarshipModelTest(TestCase):
    def test_create_starship(self):
        ...
        self.assertEqual(str(starship), '(1) Name: Millennium Falcon, Model: YT-1300 light freighter')
